        ...
        <div className="flex">
          ...
          <div className="flex-1 p-4">
            <div className="flex items-start justify-between mb-2">
              <h3 className="font-bold text-base text-dark dark:text-white line-clamp-1">{hostel.hostelName}</h3>
            ...
            <div className="flex items-center gap-2 text-gray-600 dark:text-gray-300 mb-2">
              <Location size={14} className="text-gray-400 dark:text-gray-500 flex-shrink-0" />
  ...
  return (
    ...
    >
      <div className="relative h-48">
        ...
        >
          <Heart size={20} className={isLiked ? "text-red-500 fill-current" : "text-gray-600 dark:text-gray-300"} />
        </button>
      ...
      <div className="p-5 space-y-4">
        <div>
          <h3 className="font-bold text-lg text-dark dark:text-white line-clamp-1 mb-2">{hostel.hostelName}</h3>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 line-clamp-2 leading-relaxed">{hostel.description}</p>
        </div>
        ...
        {showFeatures && hostel.features && hostel.features.length > 0 && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-gray-400 dark:text-gray-500">{hostel.features.length} features</span>
            </div>
