...
const Checkout = () => {
  return (
    <main>
      {" "}
      <TitleHead title="checkout" />
      <section className="h-full w-full p-5 mt-14">
        ...
        <div className="space-y-4">
          <Link
            ...
            className="w-full flex items-center justify-between p-4 border border-[#A64e1b] rounded-lg text-left"
          >
        ...
        <div className="flex items-center justify-between mt-6">
          <button className="w-1/2 py-2 border bg-[#E6CDBF] text-xs border-[#A64e1b] text-brown-500 rounded-lg mr-2">
            Cancel
          </button>
          <button className="w-1/2 p-3 bg-primary text-white text-xs rounded-lg ml-2">
            Proceed Payment
          </button>
        </div>
      </section>
