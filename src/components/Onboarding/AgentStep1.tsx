        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border-2 border-primary/30 dark:border-primary/20 px-4 py-8 mb-8 transition-colors duration-300">
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-dark dark:text-white mb-1">List Properties</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Showcase your hostels with detailed listings and photos
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-dark dark:text-white mb-1">Reach Students</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-dark dark:text-white mb-1">Grow Business</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Simplify bookings and manage properties effortlessly
                </p>
              </div>
            </div>
          </div>
