...
import { RiHeart2Line, RiMapPin2Line } from "react-icons/ri";
        ...
        {[1, 2, 3, 4, 5]?.map((item) => (
          <div className="bg-white min-w-[80vw]" key={item}>
            <div className="relative">
              ...
              />
              <button className="absolute top-2 right-2 bg-white/20 bg-opacity-25  rounded-xl p-2 shadow-md">
                <RiHeart2Line />
              </button>
            </div>
            <h3 className="font-semibold mt-4 text-dark">Aspire Stay Inn</h3>
