    ...
    <section className="min-h-dvh w-full flex items-center justify-center p-6 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="w-full max-w-md">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/40 rounded-xl flex items-center justify-center">
                <Shop size={24} className="text-blue-600 dark:text-blue-400" />
              </div>
              <div>
                <h3 className="font-semibold text-dark dark:text-white mb-1">Easy Listing</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  List properties with detailed information and high-quality photos
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-green-100 dark:bg-green-900/40 rounded-xl flex items-center justify-center">
                <Chart size={24} className="text-green-600 dark:text-green-400" />
              </div>
              <div>
                <h3 className="font-semibold text-dark dark:text-white mb-1">Track Inquiries</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Monitor and manage all student inquiries in one place
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-dark dark:text-white mb-1">Direct Communication</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Connect with students through our integrated messaging system
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <Link
            to="/signup"
            className="block text-center text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors duration-200 font-medium"
          >
            Skip for now
          </Link>
        </div>
