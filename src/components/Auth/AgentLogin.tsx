...
const AgentLogin: React.FC = () => {
  ...
  return (
    ...
    <div className='bg-[#E6CDBF4D] p-5 rounded-xl my-5'>
        <div>
            <h2 className='text-primary text-[24px] font-bold leading-7'>Welcome Back</h2>
            <p className='text-dark text-[14px] leading-5 font-normal my-2'>Log in to continue</p>
        </div>
        ...
        <form className='space-y-5' onSubmit={handleSubmit(handleLogin)}>
          ...
          <div className="w-full">
            ...
            <small className='capitalize text-right text-primary text-[12px] leading-5 font-normal'>Forget password</small>
          </div>
          <div>
    ...
    <div className='flex items-center justify-center my-10'>
        <small className='text-dark text-[14px] leading-5 text-center'>Already have account?{" "}
            <Link className='text-primary' to={'/agent/signup'}>Sign Up In</Link>
        </small>
    </div>
  </section>
  )
