...
const Pricing = () => {
  ...
  const plans: PricingPlan[] = [
    ...
    },
    {
      ...
      badge: "Most Popular",
      badgeColor: "bg-primary text-white dark:bg-primary dark:text-white",
      popular: true,
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-5 px-4 transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-base text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
            ...
            <div className="flex items-center justify-center space-x-4 mb-8">
              <span
                className={`text-sm font-medium ${!isAnnual ? "text-primary" : "text-gray-500 dark:text-gray-400"}`}
              >
                Monthly
              </span>
              <button
              ...
              >
                Annual
                <span className="ml-1 text-xs bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300 px-2 py-1 rounded-full">
                  Save 17%
                </span>
              </span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan) => (
              <div
                key={plan.id}
                className={`relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg border-2 transition-all duration-300 hover:shadow-custom ${
                  plan.popular
                ...
                <div className="p-8">
                  ...
                  <div className="text-center mb-8">
                    <div className="flex justify-center mb-4">
                      <div
                        className={`p-3 rounded-full ${
                          plan.popular ? "bg-primary/10" : "bg-gray-100 dark:bg-gray-700"
                        }`}
                      >
                        <div className={plan.popular ? "text-primary" : "text-gray-600 dark:text-gray-300"}>
                          {plan.icon}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-6">
                      ...
                      {plan.price !== "Free" && (
                        <span className="text-gray-500 dark:text-gray-400 text-sm">/{isAnnual ? "year" : "month"}</span>
                      )}
                      {plan.price !== "Free" && !isAnnual && (
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                          ~${plan.id === "pro" ? "2" : "5"}/month
                        </p>
                      )}
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
                  What happens if I exceed my hostel limit?
                </h4>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
